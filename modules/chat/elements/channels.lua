...
-- xp
match_strings[#match_strings + 1] = { makePattern(COMBATLOG_XPGAIN_FIRSTPERSON), add_basic_formatting('%2 XP: %1',
	"4488FF") }                                                                                                                -- something dies you gain experience
match_strings[#match_strings + 1] = { makePattern(COMBATLOG_XPGAIN_FIRSTPERSON_UNNAMED), add_basic_formatting('%1 XP',
	"4488FF") }                                                                                                                -- you gained experience
...
-- reputation
match_strings[#match_strings + 1] = { makePattern(FACTION_STANDING_DECREASED), add_basic_formatting('%2 Reputation: %1',
	"22FF66") }                                                                                                                       -- you lost reputation
match_strings[#match_strings + 1] = { makePattern(FACTION_STANDING_DECREASED_GENERIC), add_basic_formatting(
'Reputation: %1', "22FF66") }                                                                                                         -- you lost reputation
match_strings[#match_strings + 1] = { makePattern(FACTION_STANDING_INCREASED), add_basic_formatting('%2 Reputation: %1',
	"22FF66") }                                                                                                                       -- you gained guildxp
match_strings[#match_strings + 1] = { makePattern(FACTION_STANDING_INCREASED_GENERIC), add_basic_formatting(
'Reputation: %1', "22FF66") }                                                                                                         -- you gained guildxp
...
match_strings[#match_strings + 1] = { makePattern(LOOT_ITEM_CREATED_SELF_MULTIPLE), add_basic_formatting(
'+ %2 %1 Created') }
...
match_strings[#match_strings + 1] = { makePattern(LOOT_ROLL_GREED_SELF), add_basic_formatting(
"|HlootHistory:%1|h[Loot]|h: Greed selected for: %2", "00AA11") }
match_strings[#match_strings + 1] = { makePattern(LOOT_ROLL_NEED), add_basic_formatting("Need %2 by %1", "FFAA00") }
match_strings[#match_strings + 1] = { makePattern(LOOT_ROLL_NEED_SELF), add_basic_formatting(
"|HlootHistory:%1|h[Loot]|h: Need selected for: %2", "FFAA00") }
match_strings[#match_strings + 1] = { makePattern(LOOT_ROLL_PASSED), add_basic_formatting("Pass %2 by %1") }
match_strings[#match_strings + 1] = { makePattern(LOOT_ROLL_PASSED_SELF), add_basic_formatting(
"|HlootHistory:%1|h[Loot]|h: Pass selected for: %2") }
