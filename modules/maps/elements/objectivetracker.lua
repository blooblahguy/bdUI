...
function mod:create_objective_tracker()
	...
	local frame = ObjectiveTrackerFrame or WatchFrame
	frame:SetClampedToScreen(false)
	-- bdUI:RawHook(ObjectiveTrackerFrame, "OnEditModeEnter", noop, true)
	-- local frame = ObjectiveTrackerBlocksFrame or ObjectiveTrackerFrame
	-- local ignore_point
