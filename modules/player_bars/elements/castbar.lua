...
function mod:create_castbar(self)
	...
	self.Castbar:SetWidth(config.resources_width - config.castbar_height - bdUI.get_border())
	...
	self.Castbar.Icon:SetPoint("TOPRIGHT", self.Castbar, "TOPLEFT", -bdUI.get_border(), 0)
