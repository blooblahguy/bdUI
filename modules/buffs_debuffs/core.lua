...
local total = 0
local debuff_colors = { ['Magic'] = { 0.20, 0.60, 1.00 }, ['Curse'] = { 0.60, 0.00, 1.00 }, ['Disease'] = { 0.60, 0.40, 0 }, ['Poison'] = { 0.00, 0.60, 0 }, ['None'] = { 0.6, 0.1, 0.2 } }
...
local function update_aura(button, index)
	...
	local name, texture, count, debuffType, duration, expiration, caster, isStealable, nameplateShowSelf, spellID, canApply, isBossDebuff, casterIsPlayer, nameplateShowAll, timeMod, effect1, effect2, effect3 = AuraUtil.UnpackAuraData(C_UnitAuras.GetAuraDataByIndex(unit, index, filter))
